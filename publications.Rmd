...
- @mosnaLegacyPrivilegeSocial2026 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/mosnaLegacyPrivilegeSocial2026.pdf) identifies a new road to female power in nature: the female-biased inheritance of privilege -- published in *Science Advances*.
- @kravchenkoShorterWarmerWinters2025 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/kravchenkoShorterWarmerWinters2025.pdf) is a combination of physiological experiments and heavy computations to hindcast and forecast the impact of climate change onto the hibernation area of a European bat -- published in *Ecology Letters*.
- @appletonProtectedAreaPersonnel2022 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/appletonProtectedAreaPersonnel2022.pdf) is an assessment of the current and future needs in terms of workforce involved in the protection of wild lands -- published in *Nature Sustainability*.
- @rickardMothersHigherTwinning2022 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/rickardMothersHigherTwinning2022.pdf) is paper investigating the relationship between twinning and fertility in Humans and illustrating a new type of Simpson's paradox -- published in *Nature Communications*.
- @radchukAdaptiveResponsesAnimals2019 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/radchukAdaptiveResponsesAnimals2019.pdf) is a meta-analysis quantifying precisely the extent to which animals (mostly birds) are adapting to changing climate -- published in *Nature Communications*.
- @vullioudSocialSupportDrives2019 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/vullioudSocialSupportDrives2019.pdf) is an in-depth study of social hierarchy in spotted hyenas revealing how social rank emerges from simple behavioural rules -- published in *Nature Ecology & Evolution*.
- @corbettTransitionModernityChronic2018 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/corbettTransitionModernityChronic2018.pdf) is a review of the causes and consequences of demographic transitions in humans, with an emphasis on human health -- published in *Nature Reviews Genetics*.
- @lahdenperaDifferencesAgespecificMortality2018 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/lahdenperaDifferencesAgespecificMortality2018.pdf) is a detailed study of how capture influences survival in Asian elephants -- published in *Nature Communications*.
